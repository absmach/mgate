...
// func New(config mproxy.Config, handler mproxy.Handler, interceptor mproxy.Interceptor, logger *slog.Logger) *Proxy {
// 	return &Proxy{
// 		config:      config,
// 		handler:     handler,
// 		logger:      logger,
...
// 	if err = mproxy.Stream(ctx, inbound, outbound, p.handler, p.interceptor, clientCert); err != io.EOF {
